                ...
                {saibaMais && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-500 p-6 rounded-xl shadow-xl z-50 w-200 h-160 flex flex-col justify-between items-center">

                            <DetalhesSistemas onClose={() => setSaibaMais(false)} />
